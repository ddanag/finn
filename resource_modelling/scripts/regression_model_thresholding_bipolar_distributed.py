...
#get records where ram_style=distributed
df = df[df['ram_style'].astype(str) == 'distributed']
df_unseen_test_set = df_unseen_test_set[df_unseen_test_set['ram_style'].astype(str) == 'distributed']
...
def generate_graph_test_set(parameter, res_class):
    ...
    fig.savefig('../graphs/%s/plot_%s_vs_%s_thresholding_bipolar_distributed.png' % (directory_name, 'pe', 'LUT'), bbox_inches='tight')
