...
#report_folder_name = "output_cnv-w1a1_xilinx_u250_xdma_201830_2_standalone_thresholds_folding_x2"
...
for ind in layers_df_reordered.index:
    if ind in index_in_range:
        res_svr_finn.append(layers_df_reordered['res_svr_lut'][ind])
    elif ind in index_out_of_range:
        res_svr_finn.append(layers_df_reordered['res_finn_lut'][ind])
...
layers_df_reordered['svr_rel_error'] = (abs(layers_df_reordered['res_svr_lut']  - layers_df_reordered['res_synth_lut'])/layers_df_reordered['res_synth_lut_denom']) * 100
...
df_temp["layer"] = ["StreamingFCLayer_Batch", "Thresholding_Batch", "ConvolutionInputGenerator", "Total"]
df_temp["total_finn_lut"] = [0, 0, 0, 0]
df_temp["total_finn_bram"] = [0, 0, 0, 0]
df_temp["total_hls_lut"] = [0, 0, 0, 0]
df_temp["total_hls_bram"] = [0, 0, 0, 0]
df_temp["total_svr_lut"] = [0, 0, 0, 0]
df_temp["total_svr_bram"] = [0, 0, 0, 0]
df_temp["total_svr_finn_lut"] = [0, 0, 0, 0]
df_temp["total_svr_finn_bram"] = [0, 0, 0, 0]
df_temp["total_hls_finn_lut"] = [0, 0, 0, 0]
df_temp["total_hls_finn_bram"] = [0, 0, 0, 0]
df_temp["total_synth_lut"] = [0, 0, 0, 0]
df_temp["total_synth_bram"] = [0, 0, 0, 0]
...
df_temp["total_finn_lut"][3] = sum(df_temp["total_finn_lut"][0:3])
...
#df_temp["total_finn_bram"][3] = sum(df_temp["total_finn_bram"][0:3])
...
df_temp["total_hls_lut"][3] = sum(df_temp["total_hls_lut"][0:3])
...
#df_temp["total_hls_bram"][3] = sum(df_temp["total_hls_bram"][0:3])
...
df_temp["total_svr_lut"][3] = sum(df_temp["total_svr_lut"][0:3])
...
#df_temp["total_svr_bram"][3] = sum(df_temp["total_svr_bram"][0:3])

df_temp["total_svr_finn_lut"][0] = sum(df_fc['res_svr_finn_lut'])
df_temp["total_svr_finn_lut"][1] = sum(df_thresh['res_svr_finn_lut'])
df_temp["total_svr_finn_lut"][2] = sum(df_conv['res_svr_finn_lut'])
df_temp["total_svr_finn_lut"][3] = sum(df_temp["total_svr_finn_lut"][0:3])
...
df_temp["total_synth_lut"][3] = sum(df_temp["total_synth_lut"][0:3])
...
#df_temp["total_synth_bram"][3] = sum(df_temp["total_synth_bram"][0:3])
...
#df_temp["rel_error_finn_lut"] = ((df_temp["total_finn_lut"] - df_temp["total_synth_lut"])/df_temp["total_synth_lut_denom"]) * 100
...
#df_temp["rel_error_hls_lut"] = ((df_temp["total_hls_lut"] - df_temp["total_synth_lut"])/df_temp["total_synth_lut_denom"]) * 100
...
#df_temp["rel_error_svr_lut"] = ((df_temp["total_svr_lut"] - df_temp["total_synth_lut"])/df_temp["total_synth_lut_denom"]) * 100
...
df_temp["rel_error_svr_finn_lut"] = (abs(df_temp["total_svr_finn_lut"] - df_temp["total_synth_lut"])/df_temp["total_synth_lut_denom"]) * 100

df_final = pd.DataFrame()
df_final["layer"] = ["FCLayer", "FCLayer", "FCLayer", "FCLayer",#"FCLayer", "FCLayer", "FCLayer", 
                    "Thresholding", "Thresholding", "Thresholding", "Thresholding", #"Thresholding", "Thresholding", "Thresholding",
                    "SWU", "SWU", "SWU", "SWU",# "SWU",  "SWU",  "SWU",
                    "Total", "Total", "Total", "Total"#, "Total", "Total", "Total"
                    ] 

df_final["method"] = ["HLS LUT", "FINN LUT", "SVR LUT", "SVR/FINN LUT", #"HLS BRAM", "FINN BRAM", "SVR BRAM",
                    "HLS LUT", "FINN LUT", "SVR LUT", "SVR/FINN LUT",# "HLS BRAM", "FINN BRAM", "SVR BRAM",
                    "HLS LUT", "FINN LUT", "SVR LUT", "SVR/FINN LUT",# "HLS BRAM", "FINN BRAM", "SVR BRAM",
                    "HLS LUT", "FINN LUT", "SVR LUT", "SVR/FINN LUT"#, "HLS BRAM", "FINN BRAM", "SVR BRAM",
                    ]

df_final["relative error %"] = [df_temp["rel_error_hls_lut"][0], df_temp["rel_error_finn_lut"][0], df_temp["rel_error_svr_lut"][0], df_temp["rel_error_svr_finn_lut"][0],
                    #df_temp["rel_error_hls_bram"][0], df_temp["rel_error_finn_bram"][0], df_temp["rel_error_svr_bram"][0],
                    df_temp["rel_error_hls_lut"][1], df_temp["rel_error_finn_lut"][1], df_temp["rel_error_svr_lut"][1], df_temp["rel_error_svr_finn_lut"][1],
                   # df_temp["rel_error_hls_bram"][1], df_temp["rel_error_finn_bram"][1], df_temp["rel_error_svr_bram"][1],
                    df_temp["rel_error_hls_lut"][2], df_temp["rel_error_finn_lut"][2], df_temp["rel_error_svr_lut"][2], df_temp["rel_error_svr_finn_lut"][2],
                    #df_temp["rel_error_hls_bram"][2], df_temp["rel_error_finn_bram"][2], df_temp["rel_error_svr_bram"][2],
                    df_temp["rel_error_hls_lut"][3], df_temp["rel_error_finn_lut"][3], df_temp["rel_error_svr_lut"][3], df_temp["rel_error_svr_finn_lut"][3]
                    #, df_temp["rel_error_hls_bram"][3], df_temp["rel_error_finn_bram"][3], df_temp["rel_error_svr_bram"][3]
                    ]
...
barplot.set_title("%s" % report_folder_name)
...
textstr = '\n'.join((
        'Total LUT',
        ' ',
        'Total FINN = %d' % (df_temp["total_finn_lut"][3]),
        'Total HLS = %d' % (df_temp["total_hls_lut"][3]),
        'Total SVR = %d' % (math.ceil(df_temp["total_svr_lut"][3])),
        'Total SVR/FINN = %d' % (math.ceil(df_temp["total_svr_finn_lut"][3])),
        'Total SYNTH = %d' % (df_temp["total_synth_lut"][3]),
        ' ',
        'Total LUT FCLayer',
        ' ',
        'Total FINN = %d' % (df_temp["total_finn_lut"][0]),
        'Total HLS = %d' % (df_temp["total_hls_lut"][0]),
        'Total SVR = %d' % (math.ceil(df_temp["total_svr_lut"][0])),
        'Total SVR/FINN = %d' % (math.ceil(df_temp["total_svr_finn_lut"][0])),
        'Total SYNTH = %d' % (df_temp["total_synth_lut"][0]),
        ' ',
        'Total LUT Thresholding',
        ' ',
        'Total FINN = %d' % (df_temp["total_finn_lut"][1]),
        'Total HLS = %d' % (df_temp["total_hls_lut"][1]),
        'Total SVR = %d' % (math.ceil(df_temp["total_svr_lut"][1])),
        'Total SVR/FINN = %d' % (math.ceil(df_temp["total_svr_finn_lut"][1])),
        'Total SYNTH = %d' % (df_temp["total_synth_lut"][1]),
        ' ',
        'Total LUT SWU',
        ' ',
        'Total FINN = %d' % (df_temp["total_finn_lut"][2]),
        'Total HLS = %d' % (df_temp["total_hls_lut"][2]),
        'Total SVR = %d' % (math.ceil(df_temp["total_svr_lut"][2])),
        'Total SVR/FINN = %d' % (math.ceil(df_temp["total_svr_finn_lut"][2])),
        'Total SYNTH = %d' % (df_temp["total_synth_lut"][2]),
        ' ',
        #'Total BRAM',
        #' ',
        #'Total FINN = %d' % (df_temp["total_finn_bram"][3]),
        #'Total HLS = %d' % (df_temp["total_hls_bram"][3]),
        #'Total SVR = %d' % (math.ceil(df_temp["total_svr_bram"][3])),
        #'Total SYNTH = %d' % (df_temp["total_synth_bram"][3]),
        ))
...
#import pdb; pdb.set_trace()
fig.savefig('../graphs/plot_rel_error_%s_extended.png' % report_folder_name, bbox_inches='tight')
